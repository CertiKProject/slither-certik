...
class ContractSolc(CallerContextExpression):
    ...
    def _analyze_function_list(self, function_list: List, type_name: Type, uf : Structure) -> None:
    ...
    def _check_aliased_import(self, first_part: str, function_name: str, type_name: Type, uf: Structure) -> None:
    ...
    def _analyze_top_level_function(self, function_name: str, type_name: Type, uf: Structure) -> None:
