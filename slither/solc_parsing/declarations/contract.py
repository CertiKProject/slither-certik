...
class ContractSolc(CallerContextExpression):
    ...
    def _analyze_function_list(self, function_list: List, type_name: USING_FOR_KEY, uf : Structure) -> None:
    ...
    def _check_aliased_import(
        self, first_part: str, function_name: str, type_name: USING_FOR_KEY, uf: Structure
    ) -> None:
    ...
    def _analyze_top_level_function(self, function_name: str, type_name: USING_FOR_KEY, uf: Structure) -> None:
    ...
    def _analyze_library_function(
        self, library_name: str, function_name: str, type_name: USING_FOR_KEY, uf: Structure
    ) -> None:
