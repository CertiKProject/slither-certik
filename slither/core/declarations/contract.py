...
class Contract(SourceMapping):  # pylint: disable=too-many-public-methods
    ...
    def __init__(self, compilation_unit: "SlitherCompilationUnit", scope: "FileScope") -> None:
        ...
        self._using_for_src: Dict[USING_FOR_KEY, List[Tuple[Union["UserDefinedType", "FunctionTopLevel", "FunctionContract"], "Structure"]]] = {}
    ...
    @property
    def using_for_src(self) -> Dict[USING_FOR_KEY, List[Tuple[Union["UserDefinedType", "FunctionTopLevel", "FunctionContract"], "Structure"]]]:
